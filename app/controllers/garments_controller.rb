class GarmentsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @garment.save
        format.html { redirect_to root_path(garment_type: @garment.garment_type.id), notice: 'Garment was successfully created.' }
  ...
  private
    ...
    def garment_params
      params.require(:garment).permit(:wardrobe_id, :garment_type_id, :photo)
    end
end
